...
| `Sources/WallpaperVideoStore.swift` | 全ディスプレイ共通の壁紙動画ストア（seam: `WallpaperVideoStoring`、用語は `CONTEXT.md`） |
| `Sources/NSScreen+DisplayID.swift` | `CGDirectDisplayID`（roster キー）取得拡張 |
